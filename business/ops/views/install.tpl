        ...
        <form action="/" method="post">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group has-feedback">
                        <input type="text" name="host" class="form-control" placeholder="数据库主机" value="localhost"
                               data-rule="{'messages':{'required':'数据库地址不能为空'}}"
                               required>
                        <span class="fa fa-ioxhost form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                        <input type="text" name="port" class="form-control" placeholder="数据库端口"
                               data-rule="{'digits':true,'messages':{'digits':'端口号必须是数字'}}"
                               required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group has-feedback">
                        <input type="password" class="form-control" placeholder="请重新输入密码"
                               data-rule="{'equalTo':'#register_password','messages':{'equalTo':'两次输入的密码不一致'}}"
                               required>
